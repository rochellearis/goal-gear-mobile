...
class MyHomePage extends StatelessWidget {
  ...
  final String nama = "Rochelle Marchia Arisandi"; //nama
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        // Judul aplikasi "Goal Gear" dengan teks putih dan tebal.
        title: const Text(
          'Goal Gear',
          style: TextStyle(
            color: Colors.white,
...
class ItemHomepage {
  final String name;
  final IconData icon;
  final Color color; // for button colors
